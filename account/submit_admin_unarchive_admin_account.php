...
$admin_id_query = mysqli_query($conn, "SELECT * FROM administrators WHERE administrator_id='$admin_id' AND administrator_archived=1");
...
if(!($row=$admin_id_query->fetch_row())){
    ...
    echo '<script>window.location.href = "admin_unarchive_admin_account.php"</script>';
} else{
